    ...
    <section id='home' className='min-h-screen justify-center bg-grid'>
      <div className='text-center mx-auto max-w-5xl flex flex-col items-center gap-8 px-8 font-bold'>
        ...
        <div className='flex flex-col md:flex-row justify-center gap-3 md:gap-6  text-sm md:text-lg font-bold'>
          ...
          <button className="flex items-center justify-center px-4 md:px-8 py-2 border-2 border-neutral-800 bg-neutral-100 hover:bg-neutral-200 text-neutral-800 dark:bg-transparent dark:text-neutral-100 dark:border-neutral-300 rounded-md hover:bg-neutral'-200 dark:hover:bg-neutral-800 transition">
            Download Resume
